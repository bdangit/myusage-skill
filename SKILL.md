...
```
python3 {SKILL_DIR}/scripts/generate_report.py --extract
```

The JSON includes: a summary (totals, peak hour, peak day, avg session duration, tools used), session character breakdown (autonomous/deeply_engaged/general), conversation categories, top projects, models used, and the 25 most recent sessions with up to 6 user messages each.

Read the data thoroughly before writing insights.
  ...
  "sections": [
    {
      ...
      "bullets": [
        "Bullet 1 about a specific project or topic",
        "Bullet 2 about another topic",
        "Bullet 3"
      ]
    },
    {
...
```
python3 {SKILL_DIR}/scripts/generate_report.py --insights /tmp/myusage-insights.json --output ~/Desktop/myusage-report.html
```
