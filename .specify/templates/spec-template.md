...
- **EVAL-001 (US1)**: [Describe what input is given and what output is verified]
- **EVAL-002 (US2)**: [Describe what input is given and what output is verified]
- **EVAL-N**: [Add one per user story]
